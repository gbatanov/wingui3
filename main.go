//go:generate go-winres make --file-version=v0.2.57.6 --product-version=git-tag
package main
...
var Version string = "v0.2.59" // Windows - подставится после генерации во время исполнения программы
